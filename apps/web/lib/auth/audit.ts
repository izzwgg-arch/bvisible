...
export type AuditAction =
  ...
  // Bid Estimator (guided seven-step workflow)
  | 'bid_estimate_created'
  | 'bid_source_uploaded'
  | 'bid_source_revision_uploaded'
  | 'bid_source_processed'
  | 'bid_source_processing_failed'
  | 'bid_takeoff_imported'
  | 'bid_match_confirmed'
  | 'bid_question_answered'
  | 'bid_custom_rate_approved'
  | 'bid_standard_sign_promoted'
  | 'bid_line_added'
  | 'bid_line_excluded'
  | 'bid_draft_repriced'
  | 'bid_design_saved'
  | 'bid_installation_saved'
  | 'bid_project_details_saved'
  | 'vendor_created'
  | 'vendor_updated'
  | 'po_created'
  ...
  | 'po_office_reminder_resent'
  | 'amazon_punchout_started'
  | 'amazon_punchout_start_failed'
  | 'amazon_order_placed'
  | 'amazon_order_failed'
  | 'po_deleted'
  | 'po_draft_admin_notified'
  | 'po_draft_reminder_sent'
  | 'po_line_catalog_autocreated'
  | 'email_ingest_tick'
