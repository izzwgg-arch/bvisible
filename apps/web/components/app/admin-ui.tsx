...
export function AdminMetric({
  ...
  return (
    <div
      className={`rounded-[18px] border border-white/80 px-4 py-4 shadow-[0_18px_50px_rgba(15,23,42,0.08)] ring-1 backdrop-blur-xl ${toneClass}`}
    >
...
export function AdminPanel({
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-start justify-between gap-3 border-b border-[#eadfd3]/70 bg-[#fff4eb] px-5 py-4">
        <div>
          {eyebrow ? (
