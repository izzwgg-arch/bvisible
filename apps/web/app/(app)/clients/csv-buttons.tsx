...
import { importClientsAction } from './csv-actions';
...
export function ClientCsvButtons() {
  ...
  function onFileChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    reader.onload = (ev) => {
      ...
      startTransition(async () => {
        const r = await importClientsAction(text);
        setResult(r);
        if (r.imported > 0) {
          // Reload the page so the new customers appear
