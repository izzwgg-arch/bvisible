...
- **Estimates list** (`/estimates`) — compact table: job, client, status, sell, **Next** action, quick links (quote / PO / invoice by status). **New estimate** (`/estimates/new`) — small form + guidance; routes to create client when none exist.
